  ...
  var req = http.request(  
    _this.getOpts({url:'/execute'}), function(res) {
      ...
      res.on('end', function() {
        if (cb){ 
            try {
                var value = JSON.parse(strip(data)).value;
                cb(null, value); 
            } catch(e) {
                cb(e);
            }
    ...
    _this.getOpts({url:'/execute'}), function(res) {
      ...
      res.on('end', function() {
        if (data.charAt(0) == "<") {
            ...
            cb(null, JSON.parse(strip(data)).value);
      });
  });
...
var execAsync = webdriver.prototype.executeAsync = function(code, cb) {
  var _this = this;
...
webdriver.prototype.waitFor = function(code, cb) {
    execAsync.call(this, "var cb = arguments[arguments.length - 1];\
...
webdriver.prototype.setAsyncTimeout = function(ms, cb) {
    var _this = this;  
