apf.vector =  new (function(){
    ...
    function diffGroup(g,st,s,d,c){
        var t,m = 0;
        if(c&0xf00){// viewport
            if(c&0x100 && g.$vx!=(((t=st.vx)==0||t==null)?(s=s&0x7ffffeff,t=0):(s=s|0x100,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x100,c[t]||(c[t]=pe(t))):(d=d&0x7ffffeff,pf(t)))))m=m|0x100,g.$vx=t;
            if(c&0x200 && g.$vy!=(((t=st.vy)==0||t==null)?(s=s&0x7ffffdff,t=0):(s=s|0x200,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x200,c[t]||(c[t]=pe(t))):(d=d&0x7ffffdff,pf(t)))))m=m|0x200,g.$vy=t;
            if(c&0x400 && g.$vw!=(((t=st.vw)==null)?(s=s&0x7ffffbff,t=100):(s=s|0x400,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x400,c[t]||(c[t]=pe(t))):(d=d&0x7ffffbff,pf(t)))))m=m|0x400,g.$vw=t;
            if(c&0x800 && g.$vh!=(((t=st.vh)==null)?(s=s&0x7ffff7ff,t=100):(s=s|0x800,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x800,c[t]||(c[t]=pe(t))):(d=d&0x7ffff7ff,pf(t)))))m=m|0x800,g.$vh=t;
        }
        if(c&0xf000){// basic xywh
            if(c&0x1000  && g.$x !=(((t=st.x)==0||t==null)?(s=s&0x7fffefff,t=0):(s=s|0x1000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x1000,c[t]||(c[t]=pe(t))):(d=d&0x7fffefff,pf(t)))))m=m|0x1000,g.$x=t;
            if(c&0x2000  && g.$y !=(((t=st.y)==0||t==null)?(s=s&0x7fffdfff,t=0):(s=s|0x2000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x2000,c[t]||(c[t]=pe(t))):(d=d&0x7fffdfff,pf(t)))))m=m|0x2000,g.$y=t;
            if(c&0x4000  && g.$w !=(((t=st.w)==0||t==null)?(s=s&0x7fffbfff,t=0):(s=s|0x4000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x4000,c[t]||(c[t]=pe(t))):(d=d&0x7fffbfff,pf(t)))))m=m|0x4000,g.$w=t;
            if(c&0x8000  && g.$h !=(((t=st.h)==0||t==null)?(s=s&0x7fff7fff,t=0):(s=s|0x8000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x8000,c[t]||(c[t]=pe(t))):(d=d&0x7fff7fff,pf(t)))))m=m|0x8000,g.$h=t;
        }
        if(c&0xf0000){// xywh transform
            if(c&0x10000 && g.$sx!=(((t=st.sx)==1||t==null)?(s=s&0x7ffeffff,t=1):(s=s|0x10000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x10000,c[t]||(c[t]=pe(t))):(d=d&0x7ffeffff,pf(t)))))m=m|0x10000,g.$sx=t;
            if(c&0x20000 && g.$sy!=(((t=st.sy)==1||t==null)?(s=s&0x7ffdffff,t=1):(s=s|0x20000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x20000,c[t]||(c[t]=pe(t))):(d=d&0x7ffdffff,pf(t)))))m=m|0x20000,g.$sy=t;
            if(c&0x40000 && g.$ox!=(((t=st.ox)==0||t==null)?(s=s&0x7ffbffff,t=0):(s=s|0x40000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x40000,c[t]||(c[t]=pe(t))):(d=d&0x7ffbffff,pf(t)))))m=m|0x40000,g.$ox=t;
            if(c&0x80000 && g.$oy!=(((t=st.oy)==0||t==null)?(s=s&0x7ff7ffff,t=0):(s=s|0x80000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x80000,c[t]||(c[t]=pe(t))):(d=d&0x7ff7ffff,pf(t)))))m=m|0x80000,g.$oy=t;
       }
       if(c&0xf00000){// xywh transform part 2
            if(c&0x100000 && g.$cx!=(((t=st.cx)==0||t==null)?(s=s&0x7fefffff,t=0):(s=s|0x100000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x100000,c[t]||(c[t]=pe(t))):(d=d&0x7fefffff,pf(t)))))m=m|0x100000,g.$cx=t;
            if(c&0x200000 && g.$cy!=(((t=st.cy)==0||t==null)?(s=s&0x7fdfffff,t=0):(s=s|0x200000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x200000,c[t]||(c[t]=pe(t))):(d=d&0x7fdfffff,pf(t)))))m=m|0x200000,g.$cy=t;
            if(c&0x400000 && g.$r !=(((t=st.r)==0||t==null)?(s=s&0x7fbfffff,t=0):(s=s|0x400000,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x400000,c[t]||(c[t]=pe(t))):(d=d&0x7fbfffff,pf(t)))))m=m|0x400000,g.$r=t;
        }
        sd_s = s, sd_d = d;
        return m;
    }
    ...
    function diffVisual(g,st,s,d,c){
        var t,m = 0;
        if(c&0xf){
            if(c&0x1 && g.$f!=(((t=st.f)==null)?(s=s&0x7ffffffe,t=null):(s=s|0x1,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x1,c[t]||(c[t]=pe(t))):(d=d&0x7ffffffe,t))))m=m|0x1,g.$f=t;
            if(c&0x2 && g.$s!=(((t=st.s)==null)?(s=s&0x7ffffffd,t=null):(s=s|0x2,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x2,c[t]||(c[t]=pe(t))):(d=d&0x7ffffffd,t))))m=m|0x2,g.$s=t;
            if(c&0x4 && g.$sc!=(((t=st.sc)==null)?(s=s&0x7ffffffb,t=null):(s=s|0x4,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x4,c[t]||(c[t]=pe(t))):(d=d&0x7ffffffb,t))))m=m|0x4,g.$sc=t;
            if(c&0x8 && g.$sp!=(((t=st.sp)==null)?(s=s&0x7ffffff7,t=null):(s=s|0x8,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x8,c[t]||(c[t]=pe(t))):(d=d&0x7ffffff7,t))))m=m|0x8,g.$sp=t;
        }
        if(c&0xf0){
            if(c&0x10 && g.$o!=(((t=st.o)==null)?(s=s&0x7fffffef,t=1):(s=s|0x10,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x10,c[t]||(c[t]=pe(t))):(d=d&0x7fffffef,pf(t)))))m=m|0x10,g.$o=t;
            if(c&0x20 && g.$fo!=(((t=st.fo)==null)?(s=s&0x7fffffdf,t=1):(s=s|0x20,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x20,c[t]||(c[t]=pe(t))):(d=d&0x7fffffdf,pf(t)))))m=m|0x20,g.$fo=t;
            if(c&0x40 && g.$so!=(((t=st.so)==null)?(s=s&0x7fffffbf,t=1):(s=s|0x40,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x40,c[t]||(c[t]=pe(t))):(d=d&0x7fffffbf,pf(t)))))m=m|0x40,g.$so=t;
            if(c&0x80 && g.$sw!=(((t=st.sw)==1||t==null)?(s=s&0x7fffff7f,t=1):(s=s|0x80,t=t.indexOf&&t.indexOf('{')!=-1?(d=d|0x80,c[t]||(c[t]=pe(t))):(d=d&0x7fffff7f,pf(t)))))m=m|0x80,g.$sw=t;
        }
        sd_s = s, sd_d = d;
        return m;
    }
    ...
    (function(){
        ...
        (function(){
            ...
            this.$getTrash = function(id){
                var v, t = this.$trash;
                if(!(v = t[id])){ // find the last in the list if no match
                    for(v in t)id = v;
                    (v = t[id]).id = id;
                }
                delete t[id];
            ...
            this.$update = function(){
                apf.logw("Update called on prototype group");
            }
            ...
            this.repaint = function(){
                ...
                if(this.$viastring){ // our parent created our children
                    ...
                    for(k = this.$vmlnodes,d = this.$vmlnode.childNodes,l=d.length,i=0;i<l;i++)
                        k[i].$vmlnode = d[i];
        ...
        (function(){
            ...
            this.style = function(st){
                var ss = style_short, c = 0, m, s, d, t, i, j, k, styleid, parent = this.$parent; 
                
                // alias lut and mask values-set
                ...
                if(c&0xff){ // we have a visual style change
                    ...
                    if(!(vs = this.$vmlshape) || vs.$nodes!=1 || vs.$styleid!=styleid){
                        ...
                        if(!( vs = parent.$cache[styleid])){   // no cache available
                            if(vs = parent.$trash[styleid]){ // found one in the trash
                                ...
                                i = null;
                                for(i in parent.$trash); // find last one in trash
                                if(i)
                                    vs = parent.$trash[i];
                                else
                                    vs = new vmlshape(parent,styleid);
                                parent.$cache[styleid] = vs;
                            }
                        }
                        // alloc new slot
                        for(i = vs.$free,j = vs.$path, k = j.length;i<k && j[i]!=undefined;i++);
                        this.$pathslot = i;
                        // update the shape style
                        if((this.$vmlshape=vs).$styleid!=styleid)
                            parent.$cache[vs.$styleid = styleid] = vs;
                    } 
                    vs.$styleVisual(diffVisual(vs, st, vs.$isset, vs.$isdyn, c), sd_s, sd_d);
        ...
        function styleRect(m,s,d){
            ...
            vs.$path[this.$pathslot] = 
                ["m",parseInt(this.$x),parseInt(this.$y),
                    "r",w=parseInt(this.$w),0,0,parseInt(this.$h),
                    -w,0,"xe "].join(' ');
