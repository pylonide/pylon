...
jpf.DataBinding = function(){
    ...
    *********************************************************************/
    ...
    this.applyRuleSetOnNode = function(setname, cnode, def){
        ...
        // #ifdef __DEBUG
        if (!rules && !def)
            jpf.issueWarning(10001, "Could not find a SmartBindings rule for property '" + setname + "' for component " + this.name + " [" + this.tagName + "].")
        // #endif
