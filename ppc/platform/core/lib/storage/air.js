...
ppc.storage.modules.air = {
    ...
    _getItem: function(key){
        var storedValue = this.EncryptedLocalStore.getItem("__ppc_" + key);
    ...
    _setItem: function(key, value){
        ...
        this.EncryptedLocalStore.setItem("__ppc_" + key, bytes);
    },
	
    _removeItem: function(key){
        this.EncryptedLocalStore.removeItem("__ppc_" + key);
    },
