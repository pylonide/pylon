 ...
 * @todo docs
 */
ppc.BindingColorRule = function(struct, tagName){
...
(function(){
    this.addEventListener("DOMNodeInsertedIntoDocument", function(e){
        ...
        if (this.$bindings && this.$bindings.color) {
            ...
            ppc.setStyleRule("." + this.$baseCSSname + (ppc.isIE
            ...
            /*ppc.importCssString("." + this.$baseCSSname + " .records div.highlight{background-color:" 
...
}).call(ppc.BindingColorRule.prototype = new ppc.BindingRule());

ppc.aml.setElement("color", ppc.BindingColorRule);
// #endif
