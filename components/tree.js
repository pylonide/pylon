...
jpf.tree = function(pHtmlNode){
    ...
    ************************/
    ...
    this.__dragout = function(dragdata){
        ...
        this.__setStyleClass(this.__selected, "selected", ["dragDenied", "dragInsert", "dragAppend", "indicate"]);
    ...
    this.__dragover = function(el, dragdata, extra){
        ...
        this.__setStyleClass(this.lastel || this.__selected, "", ["dragDenied", "dragInsert", "dragAppend", "selected", "indicate"]);
        //if(this.lastel) this.__dragdeselect(this.lastel);
    ...
    this.__dragdrop = function(el, dragdata, extra){
        this.__setStyleClass(this.lastel || this.__selected, !this.lastel && this.__selected || this.lastel == this.__selected ? "selected" : "", ["dragDenied", "dragInsert", "dragAppend", "selected", "indicate"]);
        //if(this.lastel) this.__dragdeselect(this.lastel);
        //this.__dragdeselect(this.__selected);
        //this.__select(this.__selected);
    ...
    ************************/
    ...
    this.initNode = function(xmlNode, state, Lid){
        ...
        elSelect.setAttribute("onmousedown", 'var o = jpf.lookup(' + this.uniqueId + ');if(!o.renaming && o.isFocussed() && jpf.XMLDatabase.isChildOf(o.__selected, this) && o.selected) this.dorename = true;o.select(this);if(o.onmousedown) o.onmousedown(event, this);' + (strFunc2 && this.opencloseaction == "onmousedown" ? strFunc2 : ""));
        ...
        if(strTooltip) this.__getLayoutNode("item").setAttribute("title", strTooltip);
    ...
    this.__updateNode = function(xmlNode, htmlNode){
        ...
        var strTooltip = this.applyRuleSetOnNode("tooltip", xmlNode);
        if(strTooltip) htmlNode.setAttribute("title", strTooltip);
