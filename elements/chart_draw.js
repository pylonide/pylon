...
//e.poly3D([0,1,2,3,-1],[["vx1","vy1",0],["vx1","vy2",0],["vx2","vy2",0],["vx2","vy1",-1]]),
            ...
            "for(x+=idx,i=0;x<x2",d.forx,";x+=idx",d.incx,")",d.ifx,"{",
                "xa = ",d.x,",ya=",d.y,";",
                e.lineTo3D("xa","ya",parseFloat(s.graph.zpos),"xi=","yi="),
                e.lineTo3D("xa","ya",parseFloat(s.graph.zpos)+parseFloat(s.graph.depth), "xc=","yc="),
                "if(!i){i++;",
                    e.lineTo3D("xb","yb",parseFloat(s.graph.zpos)+parseFloat(s.graph.depth)),
                "} else {",
                    e.lineTo("xd","yd"), 
                "}",
                e.close(),
    ...
    pie2D : function(l,d,s){
        ...
        var c = e.optimize([
           ...
           "var x1=",d.vx1,",x2=",d.vx2,",xw=x2-x1,",
            ...
            "\n\n/*------ pie2D Mousecode ------ */\n",
            "if(m){",
                e.beginMouseState(s.graph,e,e.shapedPart,6),
            ...
            e.beginLayer(l),
            e.clear(),
            e.beginState(s.graph,e,e.shapedPart,6),
            "for(rx=0,x=x1;x<x2",d.forx,";x+=idx",d.incx,")",d.ifx,"{",
/*                e.drawState(d.state,d.time,"xc","yc","wq","hq",
    ...
    dt_math1X : function(l) {
        return {
            ...
            x : "x",
            y : "("+jpf.draw.getXYWH(l.pformula,'x')+")"
        };
    },
    ...
    dt_math2X : function(l){
        return {
            ...
            stats : "", seek : "",
            forx : "",  ifx : "", incx : "",ifdraw : "",
            x : "("+jpf.draw.getXYWH(l.pformula,'x')+")",
            y : "("+jpf.draw.getXYWH(l.pformula,'y')+")"
        };
    },
