...
}if(b===4&&sAgent.indexOf("chrome")>-1){b=2;}if(b===4&&sAgent.indexOf("firefox")>-1){b=0;
}this.isOpera=b===4||b===5;this.isKonqueror=b===5;this.isSafari=b===3;this.isSafariOld=false;
