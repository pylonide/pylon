...
this.$supportedProperties.push("openadd","startcollapsed","nocollapse","singleopen","prerender","removecontainer","animation");
...
});if(typeof requirejs!=="undefined"){var deps=[];if(deps.length){require(deps,function(){apf.start();
