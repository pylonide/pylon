...
}}if(!canSelect){if(e.preventDefault){e.preventDefault();}try{if(document.activeElement&&document.activeElement.contentEditable=="true"){document.activeElement.blur();
