...
/*global winGoToFile winBlockGotoFile txtGoToFile dgGoToFile tabEditors vboxGoToFile*/
...
module.exports = (function () {
    ...
    filter : function(keyword, nosel, force){
        ...
        for (var ni = Math.max(dgGoToFile.$viewport.limit - 3, nodes.length - 1); ni >= 0; ni--) {
            if (hash[ide.davPrefix + nodes[ni].firstChild.nodeValue]) {
                dgGoToFile.select(nodes[ni]);
                return;
            }
        }
